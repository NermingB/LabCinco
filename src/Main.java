...
public class Main {
	...
	public static void main(String[] args) {
        ...
        //Make user enter a hexadecimal
        System.out.println("Enter a hexadecimal number: ");
        userNum = scnr.nextLine();

        if(userNum.startsWith("0x", 0)){
            hexaNum = true;
            //we used long so as not to cause a overflow
            long sum = 0;
            long newSum = 0;
            ...
            //do a for loop to hit each character in the string 
            for(int i = newHexaNum.length()-1; i >=0; i--){
            	//16 to the power of the length - i because i keeps decreasing
